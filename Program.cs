...
namespace DIO.Series
{
    class Program
    {
        ...
        public static void AtualizarSerie()
        {
            ...
            Serie atualizaSerie = new Serie(id: idSerie, genero: (Genero)genero, titulo: titulo, descricao: descricao, ano: ano);
        ...
        private static void InserirSerie()
        {
            ...
            Serie novaSerie = new Serie(id: repositorio.ProximoId(), genero: (Genero)genero, titulo: titulo, descricao: descricao, ano: ano);
